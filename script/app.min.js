(function () {
    ...
    function get(url){
        let promise = new Promise(function(ok,nok){
            ...
            xmlHttp.setRequestHeader("access-control-allow-headers","cache-control");
            xmlHttp.onerror = () => {
...
function Character(id, name, status, species, gender, image, origin){
    this.id = id;
    this.name = name;
    this.status = status;
...
(function() {
    ...
    function init () {
        api.get('https://rickandmortyapi.com/api/character/').then(function(response){
            ...
            //response.setRequestHeader("access-control-allow-headers","cache-control");
